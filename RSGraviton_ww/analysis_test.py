...
comp = cfg.Component(
    'example',
    files = ["root://eospublic.cern.ch///eos/fcc/hh/generation/DelphesEvents/fcc_v01/pp_jj_PT_20000_100000/events0.root"] 
    #files = ["root://eospublic.cern.ch///eos/fcc/hh/generation/DelphesEvents/fcc_v01/pp_RSGraviton_20TeV_ww/events0.root"]
)
...
pp_jj_PT_0_2000.splitFactor = 10
...
from heppy.FCChhAnalyses.RSGraviton_ww.TreeProducer_test import TreeProducer
tree = cfg.Analyzer(
    TreeProducer,
    fatjets = 'fatjets_500',
)
